...
function remove(partial){
  ...
  for (var i = 0; i < _data[type].length; i++){
    if (_data[type][i] && _data[type][i].id === id){
      ...
      console.log('DELETING ERROR: File doesn\'t exist, or has already been removed.');
    }
  } 
